export const getTimelineSteps = (universityName) => [
  {
    label: "Step 1 — Start here",
    title: "Free counselling",
    desc: `Before you even look at the ${universityName} portal, talk to us. Our counsellors map your goals, eligibility, and budget to the right programme — so you don't waste time or fees on the wrong choice.`,
  ...
  },
  {
    ...
    desc: `We verify your 10th, 12th, and graduation marksheets against ${universityName}'s eligibility criteria before you apply — so your application is never rejected on a technicality.`,
  ...
  },
  {
    ...
    title: "Register & fill the admission form",
    desc: `Now you go to the ${universityName} portal. Create your account with your Aadhar-linked mobile, link your APAAR & ABC ID, and fill in the admission form with your details.`,
  ...
  },
  {
    ...
    desc: `Upload your prepared documents directly on the ${universityName} portal. With our checklist already done, this takes under 10 minutes.`,
    highlight: "We verify your uploads before you hit submit.",
  },
  {
    label: "Step 7 — You're in",
    title: "Confirmation & onboarding support",
    desc: `Once ${universityName} confirms your admission, we help you activate your LMS, understand your study schedule, locate your regional centre — so Day 1 is smooth.`,
