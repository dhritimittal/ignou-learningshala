...
export default function ProgrammesSection({ openWizard, openProgrammeWizard, course }) {
          ...
          {displayedCourses.map((prog) => (
            ...
            >
              ...
              <Link
                ...
                className="flex h-12 items-center justify-center rounded-xl border border-[#9FD7FF] bg-[#EDF8FD] font-semibold text-[#0B6089] transition hover:bg-[#DDF2FC]"
              >
                Apply Now →
              </Link>
            </div>
