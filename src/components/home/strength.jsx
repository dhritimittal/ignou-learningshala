...
export const STRENGTHS = [
  ...
  { icon: "💼", title: "Job Readiness", desc: "Regular placement drives, mock interviews, and career support." },
  { icon: "♾️", title: "Lifelong Learning", desc: "MOOC courses and self-paced access that fits around your life and work." },
    ...
    <section className="py-8 bg-white">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          <AccentDivider />
          <h2 className="text-3xl sm:text-4xl font-black text-foreground mb-3">What {data.name} builds in you</h2>
